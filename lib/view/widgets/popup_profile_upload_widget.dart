...
class PopupProfileUploadWidget extends StatefulWidget {
  ...
  @override
  State<PopupProfileUploadWidget> createState() =>
      _ProfilePhotoUploadWidgetState();
}

class _ProfilePhotoUploadWidgetState extends State<PopupProfileUploadWidget> {
              ...
              if (imageBytes != null) ...[
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    label: const CustomText(text: 'ok', fontSize: 12),
                    style: OutlinedButton.styleFrom(
                      padding: const EdgeInsets.symmetric(vertical: 8),
