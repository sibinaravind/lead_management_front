...
//                           Expanded(
//                               flex: 3,
//                               child: CustomText(text: record.board ?? '')),
//                           Expanded(
//                               flex: 3,
//                               child:
...
//                         data: _records,
//                         customerId: widget.leadModel?.id ?? '',
//                       );
...
//       text: recordToEdit?.board ?? '',
//     );
//     final institutionController = TextEditingController(
//       text: recordToEdit?.institution ?? '',
//     );
//     final universityController = TextEditingController(
//       text: recordToEdit?.description ?? '',
//     );
//     final startYearController = TextEditingController(
//       text: recordToEdit?.yearOfPassing?.toString() ?? '',
//     );
