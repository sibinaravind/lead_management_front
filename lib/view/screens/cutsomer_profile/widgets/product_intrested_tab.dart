      ...
      child: SingleChildScrollView(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            return Obx(() {
              final lead =
                  Get.find<CustomerProfileController>().leadDetails.value;

              final productInterested = lead.productInterested;
              return Column(
                ...
                children: [
                  ...
                  if (productInterested == null || productInterested.isEmpty)
                    Center(
                      child: Column(
                        children: [
                          Icon(
                                ...
                                return Container(
                                  ...
                                  child: ResponsiveGrid(
                                    ...
                                    children: [
                                      InfoItem(
                                        label: "Offer Price",
                                        value: offer.offerPrice?.toString() ??
                                            "N/A",
