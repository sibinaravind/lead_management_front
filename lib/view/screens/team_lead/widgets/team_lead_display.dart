                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Material(
                      ...
                      child: Builder(
                        builder: (_) {
                          /// 🔹 Get existing team leads
                          final existingTeamLeads = controller.teamLeadListData
                              .map((e) => e.id)
                              .toSet();

                          /// 🔹 Get already assigned members
                          final assignedMembers = controller.teamLeadListData
                          ...
                          final availableOfficers =
                              officersController.officersList.where((officer) {
                            return officer.id != widget.officerId && // not self
                                !existingTeamLeads
                                    .contains(officer.id) && // not another lead
                                !assignedMembers.contains(
                                    officer.id); // not in another team
                          }).toList();

                          return CustomOfficersFromList(
                            buttonText: 'Add Officers',
                            buttonIcon: Icons.people_alt,
                            selectedOfficers: _selectedOfficers,
                            allOfficers: availableOfficers, // filtered list
                            ...
                            buttonColor: AppColors.blueSecondaryColor,
                            buttonWidth: 200,
                          );
                        },
                      ),
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              showLoaderDialog(context);
              await controller.deleteOfficerFromLead(
                context,
