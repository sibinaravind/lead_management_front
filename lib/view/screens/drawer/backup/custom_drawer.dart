...
//           DrawerItem(label: 'Final List', index: 12, icon: Icons.timer_rounded),
//         ]),
//     DrawerSection(
//       title: 'Interview',
//       icon: Icons.meeting_room,
//       color: AppColors.greenSecondaryColor, // Amber 500
//       items: [
//         DrawerItem(
//             label: 'Interview', index: 8, icon: Icons.fact_check_rounded),
//         DrawerItem(
...
//       items: [
//         DrawerItem(label: 'Deployed', index: 21, icon: Icons.send_rounded),
//         // DrawerItem(
