...
class _ClientDataDisplayState extends State<ClientDataDisplay> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _projectController.fetchClients();
    });
  }
                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                          ClipRRect(
                            borderRadius: BorderRadius.circular(16),
                            child: ClientUserListTable(
                                userlist: _projectController.filteredClients),
                          ),
                          Container(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        CustomText(
                                          text:
                                              "${_projectController.filteredClients.length.toString()} Clients",
                                          color: AppColors.primaryColor,
                                          fontWeight: FontWeight.w700,
                                          fontSize: 15,
                                        ),
