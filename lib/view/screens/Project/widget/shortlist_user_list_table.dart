...
class ShortlistUserListTable extends StatelessWidget {
  ...
  const ShortlistUserListTable({super.key, required this.userlist});
  @override
...
// class MatchingUserListTable extends StatefulWidget {
//   final List<ClientDataModel> userlist;
//   const MatchingUserListTable({super.key, required this.userlist});

//   @override
//   State<MatchingUserListTable> createState() => _MatchingUserListTableState();
// }

// class _MatchingUserListTableState extends State<MatchingUserListTable> {
