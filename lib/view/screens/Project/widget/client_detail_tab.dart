...
class ClientDetailTab extends StatefulWidget {
  ...
  const ClientDetailTab({
    super.key,
    required this.client,
  });

  @override
  State<ClientDetailTab> createState() => _ProjectDetailsTabState();
}

class _ProjectDetailsTabState extends State<ClientDetailTab> {
...
class ClientTab extends StatelessWidget {
  ...
  const ClientTab({super.key, required this.client});
...
//   //   Provider.of<ProjectProvider>(context,listen: false).fetchVacancyClient(context,widget.id);
//   //   data=Provider.of<ProjectProvider>(context,listen: false).vacanciesClientList;
//   // }
//
//   @override
//   void initState() {
...
//         .fetchVacancyClient(context, widget.id);
//
//     setState(() {
//       data = Provider.of<ProjectProvider>(context, listen: false)
//           .vacanciesClientList;
//     });
//   }
//
...
//       child: ListView.builder(
//         itemCount: data.length, // Number of clients
//         itemBuilder: (context, index) {
...
//                             decoration: BoxDecoration(
//                               // color: client['client_info']['status'] == 'active'
//                               color: client.clientInfo?.status == 'active'
//                                   ? Colors.green
//                                   : Colors.red,
//                               borderRadius: BorderRadius.circular(12.0),
//                             ),
...
//                   // Client Details
//                   Text('Email: ${client.clientInfo?.email}',
//                       style: TextStyle(fontSize: 16.0)),
//                   Text('Phone: ${client.clientInfo?.phone}',
//                       style: TextStyle(fontSize: 16.0)),
//                   Text(
//                     'Address: ${client.clientInfo?.address}, ${client.clientInfo?.city}, ${client.clientInfo?.country}',
//                     style: TextStyle(fontSize: 16.0),
//                   ),
...
//                       padding: EdgeInsets.symmetric(vertical: 4.0),
//                       child: Text(
//                         '\$${commission.value} on ${DateTime.parse(commission.updatedAt.toString() ?? '').toLocal().toString().split('.')[0]}',
//                         style: TextStyle(
//                             fontSize: 14.0,
//                             color: AppColors.orangeSecondaryColor),
//                       ),
