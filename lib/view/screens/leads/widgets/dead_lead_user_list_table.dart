...
class DeadLeadUserListTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var columnsData = CustomerLeadFlavour.userTableList();
    // if (drawerController.selectedIndex.value == 2) {
    //   columnsData =
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Consumer2<AppUserProvider, LeadProvider>(
          builder: (context, valueA, valueB, child) => Scrollbar(
                                  ...
                                  builder: (context) {
                                    switch (column['name']) {
                                      ...
                                      case 'Action':
                                        ...
                                        } else if (valueA.selectedIndex == 4) {
                                          return PopupMenuButton<int>(
                                              color: Colors.white,
                                              itemBuilder: (context) => [
                                                    PopupMenuItem(
