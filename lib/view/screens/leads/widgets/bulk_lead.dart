...
late List <String> _roundRobin=[];
  ...
  void initState() {
    ...
    final officeProvider = Provider.of<OfficersControllerProvider>(context, listen: false);
                                                  ...
                                                  children: [
                                                    ...
                                                    ResponsiveGrid(
                                                        ...
                                                        children: [
                                                          ...
                                                          //   isRequired: true,
                                                          // ),
                                                          Consumer<OfficersControllerProvider>(builder: (
                                                              context, officers,
                                                                  child
                                                              ){
                                                            return     CustomMultiSelectDropdownField(
                                                              label: 'Select Officers',
                                                              selectedItems: _roundRobin,
                                                              items:officers.allOfficersListData?.map((e)=>e.name).toList()??[] ,
                                                              onChanged: (selected) {
                                                                setState(() {
                                                                  _roundRobin = selected;
                                                                });
                                                              },
                                                              isRequired: true,
                                                            );
