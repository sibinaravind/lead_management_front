                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomText(
                        text: leadController.callEvents.length.toString(),
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 8),
                      CustomText(
                        text: leadController.callEvents
                            .where(
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                        color: AppColors.redSecondaryColor.withOpacity(0.3)),
                  ),
                  child: Column(
                    children: [
                      ...
                      CustomText(
                        text: leadController.callEvents
                            .where((element) => element.callStatus == "MISSED")
                            .length
                            .toString(),
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
