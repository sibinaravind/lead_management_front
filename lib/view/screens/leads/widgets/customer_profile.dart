...
class CustomerProfileScreen extends StatefulWidget {
  const CustomerProfileScreen({super.key, required this.leadId});
                  ...
                  children: [
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  CustomText(
                                    text:
                                        leadProvider.leadDetails?.name ?? 'N/A',
                                    fontSize: 24,
                                    fontWeight: FontWeight.bold,
                                        ...
                                        builder: (context) => Dialog(
                                          child: EditLeadScreen(
                                            ...
                                            selectedGender: leadProvider
                                                    .leadDetails?.gender ??
                                                '',
                                            selectedMaritalStatus: leadProvider
                                                    .leadDetails
                                                    ?.maritalStatus ??
                                                '',
                                            selectedLeadSource: leadProvider
                                                    .leadDetails?.leadSource ??
                                                '',
                                            selectedLeadCategory: leadProvider
                                                    .leadDetails?.leadSource ??
                                                '',
                                            selectedStatus: leadProvider
                                                    .leadDetails?.status ??
                                                '',
                                            selectedServiceType: leadProvider
                                                    .leadDetails?.serviceType ??
                                                '',
                                            selectedQualification: leadProvider
                                                    .leadDetails
                                                    ?.qualification ??
                                                '',
                                            selectedDistrict:
                                            ...
                                            sendGreetings: leadProvider
                                                    ...
                                                    ?.onCallCommunication ??
                                                false,
                                            sendEmail: leadProvider.leadDetails
                              ...
                              CustomText(
                                text:
                                    leadProvider.leadDetails?.clientId ?? 'N/A',
                                fontSize: 14,
                    ...
                    Row(
                      children: [
                        ...
                        // _buildStatusChip(
                        //     'REGISTRATION', AppColors.orangeSecondaryColor),
                        // const SizedBox(width: 8),
                        // _buildStatusChip('Registration Completed',
                        //     AppColors.greenSecondaryColor),
                      ],
                    ),
                  ],
                      ...
                      child: SizedBox(
                        ...
                        child: ListView(
                          children: [
                            ...
                            //     DocumentItem(
                            //         name: "SSLC Certificate", path: ''),
                            //     DocumentItem(
                            //         name: "Degree Certificate",
                            //         path: "path/to/degree.pdf"),
                            //   ],
                            // ),
                          ],
                        ),
