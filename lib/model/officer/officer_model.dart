...
OfficersList officersListFromJson(String str) => OfficersList.fromJson(json.decode(str));

String officersListToJson(OfficersList data) => json.encode(data.toJson());
...
class OfficersList {
  ...
  factory OfficersList.fromJson(Map<String, dynamic> json) => OfficersList(
